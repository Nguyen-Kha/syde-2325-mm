...
# def send_25_1_email(i):

# def send_25_2_email(i):

df = pd.read_excel('csv/test_match.xlsx')
...
with smtplib.SMTP_SSL(smtp_server, port, context=context) as server:
    ...
    for i in range(0, len(df.index)):
        ...
        # message_to25_1['To'] = df['2023_Email'][i]
        ...
        # message_to25_2['To'] = df['2023_Email'][i]
        ...
        message_to25_1.attach(MIMEText(message_contents, 'plain'))
        message_to25_1 = message_to25_1.as_string()
        # server.sendmail(sender_email, df['Email_1'][i], message_to25_1)
        # server.sendmail(sender_email, df['2023_Email'][i], message_to25_1) 
        print('Email Sent To 2025_1')
        ...
        if(not (pd.isnull(df.loc[i, '2025_2']))):
            ...
            message_to25_2.attach(MIMEText(message_contents, 'plain'))
            message_to25_2 = message_to25_2.as_string()
            # server.sendmail(sender_email, df['Email_2'][i], message_to25_2)
            # server.sendmail(sender_email, df['2023_Email'][i], message_to25_2) 
            print('Email Sent To 2025_2')
